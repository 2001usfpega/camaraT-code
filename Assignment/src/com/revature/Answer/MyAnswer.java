...
public class MyAnswer {
	...
	public static void main(String[] args) throws FileNotFoundException {
		...
		question5.subString("teresacamara", 5);
		...
		Q8solved question8=new Q8solved();
		...
		words.add("billy");
		words.add("did");
		System.out.println("this is the original Array List "+ words);
		
				
		System.out.println("this is a Array List with all the Palimdrome string " + question8.palindrome( words));
		
		// Q6. Write a program to determine if an integer is even without using the modulus operator (%)

		EvenNumber q6=new EvenNumber();
		EvenNumber.isEven(6);
	...
	System.out.println("this are the primes number withing 1 to 100");
		 for (int i = 1; i < numbers.size(); i++) {
			  if (PrimeNumber.isPrime(numbers.get(i))) {
...
*/       
       ...
       System.out.println();
  //---------------------------------------------------------------------------------------------
       File myDataFile=new File("C:/Users/tscam/Desktop/Data.txt");
        scan=new Scanner(myDataFile);
       String test="";
       String mytext;
       ...
       String sign=":";
       int limit=4;
       String[] newStr=test.split(sign, limit);
